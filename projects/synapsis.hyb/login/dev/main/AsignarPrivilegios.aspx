...
<body>
    <form id="fWebPrivilegios" runat="server">
        <div>
            ...
            <asp:CheckBox ID="ckSynapsisPanIzqModRegistroFacturasImp" Text="Factura Comercial Impoetación" runat="server"></asp:CheckBox><br />
            ...
            <asp:CheckBox ID="ckSynapsisPanIzqModRegistroProveedoresImp" Text="Proveedores Importación" runat="server"></asp:CheckBox><br />
            <asp:CheckBox ID="ckSynapsisPanIzqModRegistroProveedoresExp" Text="Proveedores Exportación" runat="server"></asp:CheckBox><br />
