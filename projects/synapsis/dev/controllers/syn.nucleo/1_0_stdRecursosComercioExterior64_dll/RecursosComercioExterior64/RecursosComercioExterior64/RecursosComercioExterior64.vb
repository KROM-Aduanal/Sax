...
#End Region
        ...
        Public Enum CamposPedimento
            ...
            <EnumMember> <Description("NUM. PEDIMENTO. COMPLETO")> CA_NUMERO_PEDIMENTO_COMPLETO = 1
            <EnumMember> <Description("T.OPER.")> CA_TIPO_OPERACION = 2
            ...
            <EnumMember> <Description("ADUANA E/S")> CA_ADUANA_ENTRADA_SALIDA = 8
            <EnumMember> <Description("MEDIO DE TRANSPORTE")> CA_MEDIO_TRANSPORTE = 9
            <EnumMember> <Description("MEDIO DE TRANSPORTE DE ARRIBO")> CA_MEDIO_TRANSPORTE_ARRIBO = 10
            <EnumMember> <Description("MEDIO DE TRANSPORTE DE SALIDA")> CA_MEDIO_TRANSPORTE_SALIDA = 11
            <EnumMember> <Description("VALOR DOLARES")> CA_VALOR_DOLARES = 12
            <EnumMember> <Description("VALOR ADUANA")> CA_VALOR_ADUANA = 13
            <EnumMember> <Description("PRECIO PAGAGO/VALOR COMERCIAL")> CA_PRECIO_PAGADO_VALOR_COMERCIAL = 14
            <EnumMember> <Description("RFC DEL IMPORTADOR/EXPORTADOR")> CA_RFC_IOE = 15
            <EnumMember> <Description("CURP DEL IMPORTADOR/EXPORTADOR")> CA_CURP_IOE = 16
            ...
            <EnumMember> <Description("VAL. SEGUROS")> CA_VALOR_SEGUROS = 19
            ...
            <EnumMember> <Description("ACUSE ELECTRÓNICO DE VALIDACIÓN")> CA_ACUSE_ELECTRONICO_VALIDACION = 29
            <EnumMember> <Description("CÓDIGO DE BARRAS")> CA_CODIGO_BARRAS = 30
            ...
            <EnumMember> <Description("DEPÓSITO REFERENCIADO Y EN SU CASO LA IMPRESIÓN DEL PAGO ELECTRÓNICO CONFORME AL APENDICE 23")> CA_DEPOSITO_REFERENCIADO = 49
            ...
            <EnumMember> <Description("CURP.")> CA_CURP_AA_REPRESENTANTE_LEGAL = 52
            <EnumMember> <Description("NOMBRE")> CA_NOMBRE_MANDATARIO_REPRESENTANTE_AA = 53
            <EnumMember> <Description("RFC.")> CA_RFC_MANDATARIO_AA_REPRESENTANTE_ALMACEN = 54
            <EnumMember> <Description("CURP.")> CA_CURP_MANDATARIO_AA_REPRESENTANTE_ALMACEN = 55
            ...
            <EnumMember> <Description("NOMBRE, DENOMINACION O RAZON SOCIAL.")> CA_NOMBRE_DENOMINACION_RAZON_SOCIAL_POC = 61
            <EnumMember> <Description("DOMICILIO.")> CA_DOMICILIO_POC = 62
            <EnumMember> <Description("VINCULACION.")> CA_VINCULACION = 63
            <EnumMember> <Description("NUM. CFDI O DOCUMENTO EQUIVALENTE.")> CA_CFDI_FACTURA = 64
            <EnumMember> <Description("FECHA.")> CA_FECHA_FACTURA = 65
            <EnumMember> <Description("INCOTERM.")> CA_INCOTERM = 66
            <EnumMember> <Description("MONEDA FACT.")> CA_CVE_MONEDA_FACTURA = 67
            <EnumMember> <Description("VAL. MON. FACT.")> CA_MONTO_MONEDA_FACTURA = 68
            ...
            <EnumMember> <Description("NOMBRE, DENOMINACION O RAZON SOCIAL.")> CA_NOMBRE_RAZON_SOCIAL_DESTINATARIO = 72
            <EnumMember> <Description("DOMICILIO.")> CA_DOMICILIO_DESTINATARIO = 73
            <EnumMember> <Description("IDENTIFICACION.")> CA_ID_TRANSPORTE = 74
            <EnumMember> <Description("PAIS.")> CA_CVE_PAIS_TRANSPORTE = 75
            <EnumMember> <Description("TRANSPORTISTA.")> CA_NOMBRE_RAZON_SOCIAL_TRANSPORTE = 76
            <EnumMember> <Description("RFC.")> CA_CVE_RFC_TRANSPORTE = 77
            <EnumMember> <Description("CURP.")> CA_CURP_TRANSPORTE_PERSONA_FISICA = 78
            <EnumMember> <Description("DOMICILIO/CIUDAD/ESTADO.")> CA_DOMICILIO_TRANSPORTE = 79
            <EnumMember> <Description("NUMERO DE CANDADO.")> CA_NUMERO_CANDADO = 80
            <EnumMember> <Description("1RA. REVISION.")> CA_NUMERO_CANDADO_1RA = 81
            <EnumMember> <Description("2DA. REVISION.")> CA_NUMERO_CANDADO_2DA = 82
            <EnumMember> <Description("NUMERO (GUIA/CONOCIMIENTO EMBARQUE) DOCUMENTOS DE TRANSPORTE")> CA_GUIA_MANIFIESTO_BL = 83
            <EnumMember> <Description("ID.")> CA_MASTER_HOUSE = 84
            <EnumMember> <Description("NUMERO DE CONTENEDOR/EQUIPO FERROCARRIL/NUMERO ECONOMICO DEL VEHICULO.")> CA_NUMERO_CONTENEDOR_FERROCARRIL_NUMERO_ECONOMICO = 85
            <EnumMember> <Description("TIPO DE CONTENEDOR/EQUIPO FERROCARRIL/NUMERO ECONOMICO DEL VEHICULO.")> CA_CVE_TIPO_CONTENEDOR = 86
            <EnumMember> <Description("CLAVE.")> CA_CVE_IDENTIFICADOR = 87
            <EnumMember> <Description("COMPL. IDENTIFICADOR 1.")> CA_COMPLEMENTO_1 = 88
            <EnumMember> <Description("COMPL. IDENTIFICADOR 2.")> CA_COMPLEMENTO_2 = 89
            ...
            <EnumMember> <Description("NUM. PEDIMENTO ORIGINAL COMPLETO")> CA_NUMERO_PEDIMENTO_ORIGINAL_COMPLETO = 98
            <EnumMember> <Description("FECHA DE OPERACION ORIGINAL.")> CA_FECHA_PEDIMENTO_ORIGINAL = 99
            <EnumMember> <Description("CVE. PEDIMENTO ORIGINAL.")> CA_CVE_PEDIMENTO_ORIGINAL = 100
            ...
            <EnumMember> <Description("OBSERVACIONES.")> CA_OBSERVACIONES_PEDIMENTO = 108

            'PARTIDAS INIT
            <EnumMember> <Description("SEC.")> CA_SECUENCIA_PARTIDA = 109
            <EnumMember> <Description("FRACCION.")> CA_FRACCION_ARANCELARIA_PARTIDA = 110
            <EnumMember> <Description("SUBD. / NÚM. IDENTIFICACIÓN COMERCIAL")> CA_NICO_PARTIDA = 111
            <EnumMember> <Description("MET. VAL.")> CA_CVE_METODO_VALORACION_PARTIDA = 112
            <EnumMember> <Description("UMC.")> CA_CVE_UMC_PARTIDA = 113
            <EnumMember> <Description("CANTIDAD UMC.")> CA_CANTIDAD_UMC_PARTIDA = 114
            ...
            <EnumMember> <Description("MODELO.")> CA_MODELO_PARTIDA = 125
            <EnumMember> <Description("CODIGO PRODUCTO.")> CA_CODIGO_PRODUCTO_PARTIDA = 126
            <EnumMember> <Description("CONTRIB A NIVEL PARTIDA")> CA_CVE_CONTRIBUCION_PARTIDA = 127
            <EnumMember> <Description("NIV/NUM. SERIE.")> CA_VINCULACION_NUMERO_SERIE_PARTIDA = 128
            <EnumMember> <Description("KILOMETRAJE.")> CA_KILOMETRAJE_PARTIDA = 129
            <EnumMember> <Description("PERMISO.")> CA_CVE_PERMISO = 130
            <EnumMember> <Description("NUMERO DE PERMISO.")> CA_NUMERO_PERMISO = 131
            <EnumMember> <Description("FIRMA DESCARGO.")> CA_FIRMA_ELECTRONICA_PERMISO = 132
            <EnumMember> <Description("VAL. COM. DLS.")> CA_VALOR_USD_PARTIDA = 133
            <EnumMember> <Description("CANTIDAD UMT/C.")> CA_CANTIDAD_UMT_UMC = 134
            <EnumMember> <Description("IDENTIF.")> CA_CVE_IDENTIFICADOR_PARTIDA = 135
            <EnumMember> <Description("COMPLEMENTO 1.")> CA_COMPLEMENTO_1_PARTIDA = 136
            <EnumMember> <Description("COMPLEMENTO 2.")> CA_COMPLEMENTO_2_PARTIDA = 137
            <EnumMember> <Description("COMPLEMENTO 3.")> CA_COMPLEMENTO_3_PARTIDA = 138
            <EnumMember> <Description("CVE. GAR.")> CA_CVE_TIPO_GARANTIA_PARTIDA = 139
            <EnumMember> <Description("INST. EMISORA.")> CA_INSTITUCION_EMISORA_GARANTIA_PARTIDA = 140
            <EnumMember> <Description("FECHA C.")> CA_FECHA_EXPIRACION_CONSTANCIA_PARTIDA = 141
            <EnumMember> <Description("NUMERO DE CUENTA.")> CA_NUMERO_CUENTA_GARANTIA_PARTIDA = 142
            ...
            <EnumMember> <Description("CANT. U.M. PRECIO EST.")> CA_CANTIDAD_UMT_PRECIO_ESTIMADO_PARTIDA = 146
            <EnumMember> <Description("VALOR MERCANCIAS NO ORIGINARIAS.")> CA_MONTO_MERCANCIAS_NO_ORIGINARIAS_PARTIDA = 147
            <EnumMember> <Description("MONTO IGI.")> CA_MONTO_IGI_PARTIDA = 148
            <EnumMember> <Description("OBSERVACIONES A NIVEL PARTIDA.")> CA_OBSERVACIONES_PARTIDA = 149
            <EnumMember> <Description("CVE. PEDIM. RECT.")> CA_CVE_PEDIMENTO_RECTIFICACION = 150
            <EnumMember> <Description("FECHA PAGO RECT.")> CA_FECHA_PAGO_PEDIMENTO_RECTIFICACION = 151
            ...
            <EnumMember> <Description("PAIS DESTINO.")> CA_CVE_PAIS_EXPORTACION = 156
            <EnumMember> <Description("NUM. PEDIMENTO EUA/CAN.")> CA_NUMERO_DOCUMENTO_IMPORTACION_EU_CAN = 157
            <EnumMember> <Description("PRUEBA SUFICIENTE.")> CA_CVE_PRUEBA = 158
            <EnumMember> <Description("TOTAL ARAN. EUA/CAN.")> CA_MONTO_IMPUESTO_PAGADO_EU_CAN = 159
            <EnumMember> <Description("MONTO EXENTO.")> CA_MONTO_IMPORTE_CONFORME_CAMPO_4 = 160
            <EnumMember> <Description("FRACC. EUA/CAN.")> CA_FRACCION_ARANCELARIA_BIEN_FINAL_EU_CAN = 161
            <EnumMember> <Description("TASA EUA/CAN.")> CA_TASA_IMPORTE_PAGADO_EU_CAN = 162
            <EnumMember> <Description("ARAN. EUA/CAN.")> CA_MONTO_IMPORTE_PAGADO_EU_CAN = 163
            ...
            <EnumMember> <Description("PARA OPERACIONES CONFORME A LA REGLA 1.9.12.Ley Aduanera, DECLARAR EL NUMERO DE IDENTIFICACION DEL EQUIPO FERROVIARIO O NUMERO DE CONTENEDOR")> CA_REGLA_1_9_12_ID_EQ_FERROVIARIO_CONTENEDOR = 170
            ...
            <EnumMember> <Description("NUMERO CONSECUTIVO QUE EL AGENTE ADUANAL O LA AGENCIA ADUANAL ASIGNE A LA PARTE II")> CA_NUMERO_CONSECUTIVO_PARTE_II = 174
            ...
            <EnumMember> <Description("CONSECUTIVO QUE EL AGENTE ADUANAL O LA AGENCIA ADUANAL ASIGNE A LA COPIA SIMPLE.")> CA_NUMERO_CONSECUTIVO_COPIA_SIMPLE = 177
            <EnumMember> <Description("PARA OPERACIONES DE LA REGLA 3.1.21.Ley Aduanera, FRACCIÓN II, INCISO d), DECLARAR EL PESO BRUTO DE LA MERCANCÍA AMPARADA POR LA COPIA SIMPLE")> CA_REGLA_3_1_21_PESO_BRUTO_MERCANCIA_COPIA_SIMPLE = 178
            <EnumMember> <Description("NUMERO DEL ACUSE DE VALOR EMITIDO POR VENTANILLA DIGITAL")> CA_NUMERO_ACUSE_VUCEM = 179
            <EnumMember> <Description("LA CANTIDAD DE MERCANCIA EN UNIDADES DE COMERCIALIZACION AMPARADA EN LA REMESA")> CA_CANTIDAD_UMC_REMESA = 180
            ...
            <EnumMember> <Description("NUMERO CONSECUTIVO QUE EL AGENTE ADUANAL O LA AGENCIA ADUANAL ASIGNE A LA REMESA DEL PEDIMENTO CONSOLIDADO")> CA_NUMERO_CONSECUTIVO_REMESA = 182
            <EnumMember> <Description("NUMERO DEL ACUSE DE VALOR DE LA RELACION DE CFDI O DOCUMENTOS EQUIVALENTES EMITIDO POR VENTANILLA DIGITAL")> CA_NUMERO_ACUSE_RELACION_CFDI_DOCUMENTO_EQUIVALENTE = 183
            <EnumMember> <Description("VALOR EN DOLARES DEL TOTAL DE CDFI O DOCUMENTOS EQUIVALENTES AMPARADOS EN LA RELACION DE CDFI O DOCUMENTOS EQUIVALENTES")> CA_VALOR_DOLARES_TOTAL_CFDI_DOCUMENTO_EQUIVALENTE = 184
            <EnumMember> <Description("PAGO ELECTRONICO")> CA_PAGO_ELECTRONICO = 185
            <EnumMember> <Description("NOMBRE DE LA INSTITUCIÓN BANCARIA")> CA_NOMBRE_INSTITUCION_BANCARIA = 186
            <EnumMember> <Description("LINEA DE CAPTURA")> CA_LINEA_CAPTURA = 187
            <EnumMember> <Description("NÚMERO DE OPERACIÓN BANCARIA")> CA_NUMERO_OPERACION_BANCARIA = 188
            <EnumMember> <Description("NÚMERO DE TRANSACCIÓN SAT")> CA_NUMERO_TRANSACCION_SAT = 189
            ...
            <EnumMember> <Description("NUMERO INTERIOR")> CA_NUMERO_INTERIOR_IOE = 193
            <EnumMember> <Description("NUMERO EXTERIOR")> CA_NUMERO_EXTERIOR_IOE = 194
            ...
            <EnumMember> <Description("NÚMERO INTERIOR PROVEEDOR/COMPRADOR")> CA_NUMERO_INTERIOR_POC = 200
            <EnumMember> <Description("NUMERO EXTERIOR PROVEEDOR/COMPRADOR")> CA_NUMERO_EXTERIOR_POC = 201
            ...
            <EnumMember> <Description("NÚMERO INTERIOR DESTINATARIO")> CA_NUMERO_INTERIOR_DESTINATARIO = 207
            <EnumMember> <Description("NÚMERO EXTERIOR DESTINATARIO")> CA_NUMERO_EXTERIOR_DESTINATARIO = 208
            ...
            <EnumMember> <Description("CANTIDAD DE MERCANCÍA EN UMT DE DESCARGO")> CA_CANTIDAD_MERCANCIA_UMT_DESCARGO = 217
            <EnumMember> <Description("FECHA DE DOCUMENTO DE PRUEBA SUFICIENTE")> CA_FECHA_DOCUMENTO_PRUEBA_SUFICIENTE = 218
            <EnumMember> <Description("ENTIDAD FEDERATIVA DE ORIGEN")> CA_ENTIDAD_FEDERATIVA_ORIGEN = 219
            <EnumMember> <Description("ENTIDAD FEDERATIVA DE DESTINO")> CA_ENTIDAD_FEDERATIVA_DESTINO = 220
            <EnumMember> <Description("ENTIDAD FEDERATIVA DEL COMPRADOR")> CA_ENTIDAD_FEDERATIVA_COMPRADOR = 221
            <EnumMember> <Description("ENTIDAD FEDERATIVA DEL VENDEDOR")> CA_ENTIDAD_FEDERATIVA_VENDEDOR = 222
            ...
            <EnumMember> <Description("CANTIDAD DE MERCANCÍA EN UMT EUA/CAN")> CA_CANT_MERCANCIA_UMT_EUA_CAN = 225
            ...
            <EnumMember> <Description("CLAVE T. TASA. PARTIDA")> CA_CVE_TIPO_TASA_PARTIDA = 236
            <EnumMember> <Description("TASA PARTIDA")> CA_TASA_PARTIDA = 237
            <EnumMember> <Description("FORMA DE PAGO PARTIDA")> CA_FORMA_PAGO_PARTIDA = 238
            ...
            <EnumMember> <Description("ANIO VALIDACION")> CA_ANIO_VALIDACION = 242
            ...
            <EnumMember> <Description("CONCEPTO DIFERENCIA DE CONTRIBUCIONES")> CA_CONCEPTO_DIFERENCIA_CONTRIBUCION = 257
            <EnumMember> <Description("CLAVE CONCEPTO DIFERENCIA DE CONTRIBUCIONES")> CA_CVE_CONCEPTO_DIFERENCIA_CONTRIBUCION = 258
            ...
            <EnumMember> <Description("ACUSE ELECTRÓNICO DE PAGO")> CA_ACUSE_ELECTRONICO_PAGO = 263
            ...
            <EnumMember> <Description("VALOR DE LOS ITEMS EN FACTURA")> CP_VALOR_FACTURA_PARTIDA = 1017
            <EnumMember> <Description("INCREMENTABLE - MONEDA DEL SEGURO")> CP_MONEDA_SEGUROS = 1018
            <EnumMember> <Description("INCREMENTABLE - FACTOR DEL SEGURO")> CP_FACTOR_SEGUROS = 1019
            <EnumMember> <Description("INCREMENTABLE - MONEDA DEL FLETE")> CP_MONEDA_FLETES = 1020
            <EnumMember> <Description("INCREMENTABLE - FACTOR DEL FLETE")> CP_FACTOR_FLETES = 1021
            <EnumMember> <Description("INCREMENTABLE - MONEDA DE OTROS")> CP_MONEDA_OTROS_INCREMENTABLES = 1022
            <EnumMember> <Description("INCREMENTABLE - FACTOR DE OTROS")> CP_FACTOR_OTROS_INCREMENTABLES = 1023
            <EnumMember> <Description("INCREMENTABLE - MONEDA DE EMBALAJES")> CP_MONEDA_EMBALAJES = 1024
            <EnumMember> <Description("INCREMENTABLE - FACTOR DE EMBALAJES")> CP_FACTOR_EMBALAJES = 1025
            <EnumMember> <Description("DECREMENTABLE - MONEDA DEL SEGURO")> CP_MONEDA_SEGUROS_DECREMENTABLES = 1026
            <EnumMember> <Description("DECREMENTABLE - FACTOR DEL SEGURO")> CP_FACTOR_SEGUROS_DECREMENTABLES = 1027
            <EnumMember> <Description("DECREMENTABLE - MONEDA DEL TRANSPORTE")> CP_MONEDA_TRANSPORTE = 1028
            <EnumMember> <Description("DECREMENTABLE - FACTOR DEL TRANSPORTE")> CP_FACTOR_TRANSPORTE = 1029
            <EnumMember> <Description("DECREMENTABLE - MONEDA DE OTROS")> CP_MONEDA_OTROS_DECREMENTABLES = 1030
            <EnumMember> <Description("DECREMENTABLE - FACTOR DE OTROS")> CP_FACTOR_OTROS_DECREMENTABLES = 1031
            <EnumMember> <Description("DECREMENTABLE - MONEDA DE CARGA")> CP_MONEDA_CARGA = 1032
            <EnumMember> <Description("DECREMENTABLE - FACTOR DE CARGA")> CP_FACTOR_CARGA = 1033
            <EnumMember> <Description("DECREMENTABLE - MONEDA DE DESCARGA")> CP_MONEDA_DESCARGA = 1034
            <EnumMember> <Description("DECREMENTABLE - FACTOR DE DESCARGA")> CP_FACTOR_DESCARGA = 1035
            <EnumMember> <Description("RECTIFICACIONES - CONTRIBUCIÓN ORIGINAL")> CP_RECTIFICACIONES_CONTRIBUCION_ORIGINAL = 1036
            <EnumMember> <Description("RECTIFICACIONES - CLAVE DE LA CONTRIBUCIÓN ORIGINAL")> CP_RECTIFICACIONES_CVE_CONTRIBUCION_ORIGINAL = 1037
            <EnumMember> <Description("RECTIFICACIONES - FORMA DE PAGO DE LA CONTRIBUCIÓN ORIGINAL")> CP_RECTIFICACIONES_FORMA_PAGO_ORIGINAL = 1038
            ...
            <EnumMember> <Description("COMPENSACIONES - NUM. PEDIMENTO ORIGINAL PARTIDA")> CP_COMPENSACION_PEDIMENTO_ORIGINAL_PARTIDA = 1043
            <EnumMember> <Description("AÑO DE VEHIDULO")> CP_ANIO_VEHICULO_ISAN = 1044
            <EnumMember> <Description("TIPO CAMBIO FECHA EXTRACCIÓN")> CP_TIPO_CAMBIO_EXTRACCION = 1045
            <EnumMember> <Description("VAL. AGREG. - MONTO MONEDA ORIGINAL PARTIDA")> CP_VALOR_AGREGADO_MONTO_ORIGINAL_PARTIDA = 1046
            <EnumMember> <Description("VAL. AGREG. - MONEDA ORIGINAL PARTIDA")> CP_VALOR_AGREGADO_MONEDA_ORIGINAL_PARTIDA = 1047
            <EnumMember> <Description("VAL. AGREG. - FACTOR CONVERSIÓN PARTIDA")> CP_VALOR_AGREGADO_FACTOR_CONVERSION_PARTIDA = 1048
            <EnumMember> <Description("DECREMENTABLE - MONTO MONEDA ORIGINAL DEL TRANSPORTE")> CP_MONTO_ORIGINAL_TRANSPORTE = 1049
            <EnumMember> <Description("DECREMENTABLE - MONTO MONEDA ORIGINAL DEL SEGURO")> CP_MONTO_ORIGINAL_SEGUROS_DECREMENTABLES = 1050
            <EnumMember> <Description("DECREMENTABLE - MONTO MONEDA ORIGINAL DE OTROS")> CP_MONTO_ORIGINAL_OTROS_DECREMENTABLES = 1051
            <EnumMember> <Description("DECREMENTABLE - MONTO MONEDA ORIGINAL DE CARGA")> CP_MONTO_ORIGINAL_CARGA = 1052
            <EnumMember> <Description("DECREMENTABLE - MONTO MONEDA ORIGINAL DE DESCARGA")> CP_MONTO_ORIGINAL_DESCARGA = 1053
            <EnumMember> <Description("INCREMENTABLE - MONTO MONEDA ORIGINAL DEL FLETE")> CP_MONTO_ORIGINAL_FLETES = 1054
            <EnumMember> <Description("INCREMENTABLE - MONTO MONEDA ORIGINAL DE EMBALAJES")> CP_MONTO_ORIGINAL_EMBALAJES = 1055
            <EnumMember> <Description("INCREMENTABLE - MONTO MONEDA ORIGINAL DE OTROS")> CP_MONTO_ORIGINAL_OTROS_INCREMENTABLES = 1056
            <EnumMember> <Description("INCREMENTABLE - MONTO MONEDA ORIGINAL DE SEGUROS")> CP_MONTO_ORIGINAL_SEGUROS_INCREMENTABLES = 1057
