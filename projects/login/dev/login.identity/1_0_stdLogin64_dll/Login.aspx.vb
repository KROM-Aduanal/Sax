...
Public Class Login
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If Request.IsAuthenticated Then
                ...
                Response.Redirect("http://localhost:14325/FrontEnd/Modulos/TraficoAA/ConsultasOperaciones/Ges003-001-Consultas.Principal.aspx")
    ...
    Sub IniciaSesion_Click()
        ...
        If tagwatcherTask_.Status = TaskStatus.Faulted Then
            ...
            MsgBox("NEVER DE LIMÖN CON ALGUNA CONDICIÖN")
        ...
        Else
            ...
            Else
                ...
                MsgBox("NEVER DE LIMÓN USUARIO INVÁLIDO")
    ...
    Private Async Function SignInAsync(context_ As IOwinContext,
        ...
        If principal_.HasClaim(Function(c) c.Type.Contains("SYNAPSIS")) Then
            ...
            .RedirectUri = "http://localhost:14325/FrontEnd/Modulos/TraficoAA/ConsultasOperaciones/Ges003-001-Consultas.Principal.aspx"
        }, identity_)
